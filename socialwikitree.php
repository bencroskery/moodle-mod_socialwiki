...
class socialwiki_node{
    ...
    function set_content($page){
        ...
        $this->content.= html_writer::link($CFG->wwwroot.'/mod/socialwiki/view.php?pageid='.$page->id,$page->title.' ID: '.$page->id,
                                           array('class'=>'colourtext', 'style'=>'display:block; margin-top:5px;')// tagcloud", "rel"=>"$this->trustvalue")
